...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.name.setText(_translate("MainWindow", "reconciliator"))
    ...
    def populateDropdowns(self):
        ...
        try:
            ...
            conn = sqlite3.connect('Database\Reconciliator.db')
            c = conn.cursor()
    ...
    def reconcile(self):
        ...
        try:
            ...
            t1 = time.time()
            if path.exists('reconciliator.xlsx'):
                xl = w3c.Dispatch('Excel.Application')
                wb = xl.Workbooks.Open('{}/reconciliator.xlsx'.format(str(os.getcwd()).replace("\\", "/")))
                wb.Close(True)
            ...
            workbook = Workbook('reconciliator.xlsx')
